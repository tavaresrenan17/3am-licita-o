-- 3AM LICITACAO - politica de admissao do incremental
-- Projeto sfjesuzvsupjlkzeijzc. Cole no SQL Editor e execute uma vez.
-- Equivale a supabase/migrations/20260915160000_admissao_incremental.sql
--
-- Substitui pncp_merge_page. A funcao antiga (5 argumentos) e DROPADA antes,
-- de proposito: com o parametro novo tendo default, um create-or-replace
-- criaria sobrecarga em vez de substituir, e a chamada ficaria ambigua.
