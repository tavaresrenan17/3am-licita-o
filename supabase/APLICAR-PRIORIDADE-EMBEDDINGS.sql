...
-- Gerado de supabase/migrations/20260918170000_prioridade_embeddings.sql
-- Aplicar DEPOIS de APLICAR-FILA-EMBEDDINGS.sql.
-- IMPORTANTE: cole o arquivo INTEIRO de uma vez, sem nenhum job de embeddings
-- rodando. Dividir o paste deixa as assinaturas antiga e nova coexistindo, e
-- uma chamada nesse intervalo falha com "is not unique".
