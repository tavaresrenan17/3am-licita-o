-- 3AM LICITACAO - metricas do painel "Oportunidades"
-- Projeto sfjesuzvsupjlkzeijzc. Cole no SQL Editor e execute uma vez.
-- Equivale a supabase/migrations/20260915180000_metricas_oportunidades.sql
--
-- Substitui metricas_dashboard e buscar_licitacoes. As duas mantem a assinatura
-- que ja tinham, entao e substituicao limpa: nao ha drop nem sobrecarga.
