-- 3AM LICITACAO - Fase 3: sincronizacao incremental
-- Projeto sfjesuzvsupjlkzeijzc. Cole no SQL Editor e execute uma vez.
-- Equivale a supabase/migrations/20260915140000_sincronizacao_incremental.sql
-- Aplicar DEPOIS de APLICAR-FASE-4.sql e APLICAR-FASE-4-CORRECAO.sql.
