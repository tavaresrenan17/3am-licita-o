-- 3AM LICITACAO - indices de consulta
-- Projeto sfjesuzvsupjlkzeijzc. Cole no SQL Editor e execute uma vez.
-- Equivale a supabase/migrations/20260915220000_indices_consulta.sql
--
-- Criar indice GIN em tabela grande pode levar alguns minutos e trava escrita.
-- Com o catalogo atual (~900 linhas) e instantaneo. Rodar fora do horario da
-- rotina noturna.
