-- ==============================================================================
-- ACERVO DE ALEXANDRIA
-- Licitações selecionadas exclusivamente para análise cautelosa e aprofundada.
-- Licitações que entram em Alexandria ficam visíveis somente em Alexandria,
-- sendo removidas da visualização geral de Licitações.
-- Podem ser devolvidas à tela de Licitações a qualquer momento.
-- ==============================================================================
...
-- Mover licitações em lote para Alexandria
...
-- Remover licitações de Alexandria (devolvendo-as para as Licitações Gerais)
...
-- Listar todos os IDs que estão atualmente em Alexandria
