-- 3AM LICITACAO - fila de documentos seletiva
-- Projeto sfjesuzvsupjlkzeijzc. Cole no SQL Editor e execute uma vez.
-- Equivale a supabase/migrations/20260915230000_fila_documentos_seletiva.sql
-- Aplicar DEPOIS de APLICAR-POSSE-E-D06.sql (usa licitacao_situacao_temporal).
